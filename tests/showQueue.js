...
const runShowQueueTests = async () => {
    ...
    try {
        ...
        console.error(chalk.red('Failure test correctly failed for /showQueue endpoint:', error.message));
    }
    ...
    try {
        ...
        if (data.error) {
            ...
            console.log(chalk.green('Test passed for /showQueue endpoint'));
        }
    } catch (error) {
...
export default runShowQueueTests;
